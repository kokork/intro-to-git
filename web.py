...
def dohvati_5_kripto_valuta() -> list[kriptovaluta]:
    ...
    svi_html_kripto_redci = soup.find_all("tr")

    kripto_valute = []
    for redak in svi_html_kripto_redci[1:6]:
...
def parsiraj_jedan_html_redak(stupci: bs4.BeautifulSoup) -> kriptovaluta:
    ...
    return kriptovaluta(
        ...
        trend_24h=trend_24h,
        trend_24h_postotak=trend_7d_postotak,
        trend_7d=trend_7d,
